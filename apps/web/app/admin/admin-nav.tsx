...
const items = [
  ...
  { href: "/admin/order-fraud-watch", label: "Fraud watch" },
  ...
  { href: "/admin/seller-inactivity", label: "Seller inactivity" },
  { href: "/admin/seller-profile-completion", label: "Profile completion" },
